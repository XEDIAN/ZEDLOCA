    ...
    return (
      <div className="min-h-screen flex flex-col justify-between bg-green-50">
        <div className="flex-1 flex flex-col items-center justify-center pb-32">
          <h1 className="text-4xl font-bold text-green-800 mb-4 mt-16">Loading...</h1>
        </div>
      </div>
    );
  }
        ...
        {seller ? (
          <div className="w-full max-w-2xl mt-8">
            <div className="flex items-center mb-6 p-4 bg-white rounded shadow">
              ...
              <div>
                <h2 className="text-2xl font-bold text-green-800">{seller.displayName}</h2>
                <p className="text-green-700">{seller.email}</p>
              </div>
            </div>
            
            <h3 className="text-xl font-semibold mb-4 text-green-800">Store Listings</h3>
          ...
          <div className="w-full max-w-2xl">
            <h2 className="text-2xl font-bold text-green-800 mb-4">Seller not found</h2>
